<template>
  <div class="animate-fade-in space-y-4">
    ...
    <div class="grid grid-cols-2 gap-3">
      ...
      <button class="action-btn action-btn--primary" @click="store.startQuiz()">
...
.row-ok {
  background: rgba(46, 94, 56, 0.04);
}
.row-ko {
  background: rgba(130, 32, 32, 0.04);
}
.result-icon {
  font-size: 1.1rem;
  flex-shrink: 0;
...
/* Divider in result list */
.divide-y > * + * {
  border-top: 1px solid rgba(172, 152, 120, 0.15);
}
...
.back-btn:hover {
  color: #7c3328;
  border-color: rgba(124, 51, 40, 0.35);
  background: rgba(124, 51, 40, 0.05);
}
</style>
